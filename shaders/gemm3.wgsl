...
fn main(
  ...
  for(var k: u32 = 0u; k < KD4; k = k + 1u) {
    ...
    result_1_2 = vec4<f32>(arow2.x) * brow + result_1_2;
    result_1_3 = vec4<f32>(arow3.x) * brow + result_1_3;
    
    brow = B[(k * 4u + 1u) * ND4 + x * 2u + 0u];
    result_0_0 = vec4<f32>(arow0.y) * brow + result_0_0;
    ...
    result_1_2 = vec4<f32>(arow2.y) * brow + result_1_2;
    result_1_3 = vec4<f32>(arow3.y) * brow + result_1_3;
    
    brow = B[(k * 4u + 2u) * ND4 + x * 2u + 0u];
    result_0_0 = vec4<f32>(arow0.z) * brow + result_0_0;
    ...
    result_1_2 = vec4<f32>(arow2.z) * brow + result_1_2;
    result_1_3 = vec4<f32>(arow3.z) * brow + result_1_3;
    
    brow = B[(k * 4u + 3u) * ND4 + x * 2u + 0u];
    result_0_0 = vec4<f32>(arow0.w) * brow + result_0_0;
    ...
    result_1_2 = vec4<f32>(arow2.w) * brow + result_1_2;
    result_1_3 = vec4<f32>(arow3.w) * brow + result_1_3;
  }
